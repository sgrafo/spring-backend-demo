package gob.bo.segip.proyecto.modulo_parametricas;
...
import gob.bo.segip.proyecto.modulo_parametricas.dominio.entidad.Ingredient.Type;
...
public class ModuloParametricasApplication {

    public static void main(String[] args) {
        SpringApplication.run(ModuloParametricasApplication.class, args);
    }
